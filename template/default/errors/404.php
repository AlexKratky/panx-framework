...
echo("<div class='error'><div class='error-title'>Error <span class='error-code'>404</span></div><div class='error-msg'>".__('notfound1')." \"" . ($UC->getLink()[count($UC->getLink())-1] == "" ? "/" : $UC->getLink()[count($UC->getLink())-1]) . "\" ".__('notfound2')."</div></div></body></html>");
?>